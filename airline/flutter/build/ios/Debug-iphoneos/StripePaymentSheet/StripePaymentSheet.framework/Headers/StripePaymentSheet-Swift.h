...
SWIFT_CLASS("_TtC18StripePaymentSheet18STPElementsSession")
@interface STPElementsSession : NSObject
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface STPElementsSession (SWIFT_EXTENSION(StripePaymentSheet)) <STPAPIResponseDecodable>
