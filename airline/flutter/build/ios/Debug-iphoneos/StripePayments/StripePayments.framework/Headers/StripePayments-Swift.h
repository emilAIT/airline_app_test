...
enum STPBankAccountCollectorUserInterfaceStyle : NSInteger;
...
- (nonnull instancetype)initWithStyle:(enum STPBankAccountCollectorUserInterfaceStyle)style;
...
typedef SWIFT_ENUM(NSInteger, STPBankAccountCollectorUserInterfaceStyle, closed) {
/// (default) The bank account collector will automatically switch between light and dark mode compatible colors based on device settings.
  STPBankAccountCollectorUserInterfaceStyleAutomatic = 0,
/// The bank account collector will always use colors appropriate for light mode UI.
  STPBankAccountCollectorUserInterfaceStyleAlwaysLight = 1,
/// The bank account collector will always use colors appropriate for dark mode UI.
  STPBankAccountCollectorUserInterfaceStyleAlwaysDark = 2,
};
...
/// note:
/// Recommended over <code>CaptureMethod.automatic</code> due to improved latency, but may require additional integration changes.
/// seealso:
/// https://stripe.com/docs/payments/payment-intents/asynchronous-capture-automatic-async
  STPPaymentIntentCaptureMethodAutomaticAsync = 3,
};
...
/// <code>@YES</code> to set this PaymentIntent’s PaymentMethod as the associated Customer’s default
/// This should be a boolean NSNumber, so that it can be <code>nil</code>
@property (nonatomic, strong) NSNumber * _Nullable setAsDefaultPM;
...
@class STPPaymentMethodSunbit;
@class STPPaymentMethodBillie;
@class STPPaymentMethodSatispay;
@class STPPaymentMethodCrypto;
@class STPPaymentMethodMultibanco;
@class STPPaymentMethodMobilePay;
enum STPPaymentMethodAllowRedisplay : NSInteger;
...
/// If this is a Sunbit PaymentMethod (i.e. <code>self.type == STPPaymentMethodTypeSunibt</code>), this contains additional details.
@property (nonatomic, readonly, strong) STPPaymentMethodSunbit * _Nullable sunbit;
/// If this is a Billie PaymentMethod (i.e. <code>self.type == STPPaymentMethodTypeBillie</code>), this contains additional details.
@property (nonatomic, readonly, strong) STPPaymentMethodBillie * _Nullable billie;
/// If this is a Satispay PaymentMethod (i.e. <code>self.type == STPPaymentMethodTypeSatispay</code>), this contains additional details.
@property (nonatomic, readonly, strong) STPPaymentMethodSatispay * _Nullable satispay;
/// If this is a Crypto PaymentMethod (i.e. <code>self.type == STPPaymentMethodTypeCrypto</code>), this contains additional details.
@property (nonatomic, readonly, strong) STPPaymentMethodCrypto * _Nullable crypto;
...
@property (nonatomic, readonly) enum STPPaymentMethodAllowRedisplay allowRedisplay;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
/// :nodoc:
- (nonnull instancetype)initWithStripeId:(NSString * _Nonnull)stripeId type:(enum STPPaymentMethodType)type allowRedisplay:(enum STPPaymentMethodAllowRedisplay)allowRedisplay OBJC_DESIGNATED_INITIALIZER;
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
typedef SWIFT_ENUM(NSInteger, STPPaymentMethodAllowRedisplay, closed) {
...
/// The Billie Payment Method.
/// seealso:
/// https://docs.stripe.com/payments/billie/accept-a-payment
SWIFT_CLASS("_TtC14StripePayments22STPPaymentMethodBillie")
@interface STPPaymentMethodBillie : NSObject
/// :nodoc:
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
...
SWIFT_CLASS("_TtC14StripePayments28STPPaymentMethodBillieParams")
@interface STPPaymentMethodBillieParams : NSObject <STPFormEncodable>
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC14StripePayments22STPPaymentMethodCrypto")
@interface STPPaymentMethodCrypto : NSObject
/// :nodoc:
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
...
SWIFT_CLASS("_TtC14StripePayments28STPPaymentMethodCryptoParams")
@interface STPPaymentMethodCryptoParams : NSObject <STPFormEncodable>
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@class STPPaymentMethodSunbitParams;
@class STPPaymentMethodSatispayParams;
...
@property (nonatomic, strong) STPPaymentMethodSunbitParams * _Nullable sunbit;
/// If this is a Billie PaymentMethod, this contains additional details.
@property (nonatomic, strong) STPPaymentMethodBillieParams * _Nullable billie;
/// If this is a Satispay PaymentMethod, this contains additional details.
@property (nonatomic, strong) STPPaymentMethodSatispayParams * _Nullable satispay;
/// If this is a Crypto PaymentMethod, this contains additional details.
@property (nonatomic, strong) STPPaymentMethodCryptoParams * _Nullable crypto;
...
/// \param sunbit An object containing additional Sunbit details.
///
/// \param billingDetails An object containing the user’s billing details.
///
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithSunbit:(STPPaymentMethodSunbitParams * _Nonnull)sunbit billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)metadata;
/// Creates params for a Billie PaymentMethod.
/// \param billie An object containing additional Billie details.
///
/// \param billingDetails An object containing the user’s billing details.
///
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithBillie:(STPPaymentMethodBillieParams * _Nonnull)billie billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)metadata;
/// Creates params for a Satispay PaymentMethod.
/// \param satispay An object containing additional Satispay details.
///
/// \param billingDetails An object containing the user’s billing details.
///
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithSatispay:(STPPaymentMethodSatispayParams * _Nonnull)satispay billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)metadata;
/// Creates params for a Crypto PaymentMethod.
/// \param crypto An object containing additional Crypto details.
///
/// \param billingDetails An object containing the user’s billing details.
///
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithCrypto:(STPPaymentMethodCryptoParams * _Nonnull)crypto billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)metadata;
...
SWIFT_CLASS("_TtC14StripePayments24STPPaymentMethodSatispay")
@interface STPPaymentMethodSatispay : NSObject
/// :nodoc:
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
...
SWIFT_CLASS("_TtC14StripePayments30STPPaymentMethodSatispayParams")
@interface STPPaymentMethodSatispayParams : NSObject <STPFormEncodable>
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC14StripePayments22STPPaymentMethodSunbit")
@interface STPPaymentMethodSunbit : NSObject
/// :nodoc:
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
...
/// An object representing parameters used to create a Sunbit Payment Method
SWIFT_CLASS("_TtC14StripePayments28STPPaymentMethodSunbitParams")
@interface STPPaymentMethodSunbitParams : NSObject <STPFormEncodable>
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
/// A Sunbit payment method
  STPPaymentMethodTypeSunbit = 32,
/// A Billie payment method
  STPPaymentMethodTypeBillie = 33,
/// A Satispay payment method
  STPPaymentMethodTypeSatispay = 34,
/// A Crypto payment method
  STPPaymentMethodTypeCrypto = 35,
/// A MobilePay payment method
  STPPaymentMethodTypeMobilePay = 36,
/// A Konbini payment method
  STPPaymentMethodTypeKonbini = 37,
/// A PromptPay payment method
  STPPaymentMethodTypePromptPay = 38,
/// A Swish payment method
  STPPaymentMethodTypeSwish = 39,
/// A TWINT payment method
  STPPaymentMethodTypeTwint = 40,
/// A Multibanco payment method
  STPPaymentMethodTypeMultibanco = 41,
/// An unknown type.
  STPPaymentMethodTypeUnknown = 42,
};
