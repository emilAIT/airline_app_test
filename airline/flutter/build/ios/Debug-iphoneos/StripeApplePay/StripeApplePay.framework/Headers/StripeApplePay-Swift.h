...
/// note:
/// Does not call the <code>applePayContext:didCompleteWithStatus:</code> delegate method.
/// note:
/// You must create a new instance of ApplePayContext after using this method.
/// \param completion Called after the Apple Pay sheet is dismissed.
///
...
/// :nodoc:
- (void)paymentAuthorizationController:(PKPaymentAuthorizationController * _Nonnull)controller didChangeCouponCode:(NSString * _Nonnull)couponCode handler:(void (^ _Nonnull)(PKPaymentRequestCouponCodeUpdate * _Nonnull))completion SWIFT_AVAILABILITY(ios,introduced=15.0);
/// :nodoc:
...
- (void)applePayContext:(STPApplePayContext * _Nonnull)context didChangeCouponCode:(NSString * _Nonnull)couponCode handler:(void (^ _Nonnull)(PKPaymentRequestCouponCodeUpdate * _Nonnull))completion SWIFT_AVAILABILITY(ios,introduced=15.0);
