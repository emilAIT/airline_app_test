...
+ (NSError * _Nonnull)stp_defaultPaymentMethodNotChangedError SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)stp_defaultPaymentMethodNotChangedMessage SWIFT_WARN_UNUSED_RESULT;
@end
...
/// by adding <code>.cartesBancaires</code> to the <code>additionalEnabledApplePayNetworks</code> list.
///
/// returns:
